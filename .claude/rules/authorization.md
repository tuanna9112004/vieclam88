...
- Staff/Branch Admin bắt buộc có Branch active, chỉ truy cập Job/Application đúng scope;
  Super Admin có `branch_id=null` và không giới hạn cơ sở. URL trực tiếp trái quyền phải 403,
  không chỉ ẩn nút.
...
- Branch Admin quản lý Staff và cập nhật Branch của chính cơ sở mình. Super Admin giữ các quyền
  toàn hệ thống: tạo/xóa/khôi phục Branch, transfer branch, merge/anonymize Candidate, duplicate
  review, delete/restore shared data và export toàn hệ thống.
