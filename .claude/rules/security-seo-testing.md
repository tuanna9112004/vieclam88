...
- HR/login noindex. Filter URL kiểm canonical. Job `closed`/`paused` giữ URL (200, không 404), rời danh sách active/sitemap, không noindex (`docs/CORE-FLOWS.md` mục 2.1, ADR-043).
