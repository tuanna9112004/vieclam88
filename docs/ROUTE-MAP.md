...
Trang chi tiết Candidate hiển thị "merged family" (`docs/CORE-FLOWS.md` mục 6.3) — với role theo
branch, danh sách Application và metadata Candidate nguồn trong family vẫn lọc theo cơ sở như
trên, không phải ngoại lệ.
